<?php /* Smarty version Smarty-3.1.7, created on 2019-06-14 21:00:37
         compiled from "C:\OpenServer\OSPanel\domains\SalesP\vtigercrm\includes\runtime/../../layouts/v7\modules\Settings\Workflows\TasksList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:192395d03e0c5b9fff6-95263945%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd544c691ec8b0d31a348e5e5734279b24c1b6fda' => 
    array (
      0 => 'C:\\OpenServer\\OSPanel\\domains\\SalesP\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\Settings\\Workflows\\TasksList.tpl',
      1 => 1523891300,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '192395d03e0c5b9fff6-95263945',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d03e0c5bda33',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d03e0c5bda33')) {function content_5d03e0c5bda33($_smarty_tpl) {?>
...
" <?php if ($_smarty_tpl->tpl_vars['TASK']->value->isActive()){?> checked="" value="on" <?php }else{ ?> value="off" <?php }?>  data-on-text="<?php echo vtranslate('LBL_YES');?>
" data-off-text="<?php echo vtranslate("LBL_NO");?>
"/></td><td class="listViewEntryValue"><?php echo vtranslate($_smarty_tpl->tpl_vars['TASK']->value->getTaskType()->getLabel(),$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</td><td><span class="pull-left"><?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['TASK']->value->getName());?>
</span></td><tr><?php } ?><tr class="listViewEntries hide taskTemplate"><td><div class="pull-left actions"><span class="actionImages"><a class="editTask"><i class="fa fa-pencil alignMiddle" ></i></a>&nbsp;&nbsp;<a class="deleteTaskTemplate"><i class="fa fa-trash alignMiddle"></i></a></span></div>&nbsp;&nbsp;<input style="opacity: 0;" type="checkbox" data-on-color="success" class="tmpTaskStatus" checked="" value="on" data-on-text="<?php echo vtranslate('LBL_YES');?>
" data-off-text="<?php echo vtranslate("LBL_NO");?>
"/></td><td class="listViewEntryValue taskType"></td><td><span class="pull-left taskName"></span></td></tr></tbody></table><?php if (empty($_smarty_tpl->tpl_vars['TASK_LIST']->value)){?><table class="emptyRecordsDiv"><tbody><tr><td><?php echo vtranslate('LBL_NO_TASKS_ADDED',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
