...
class QueryGenerator
{
    ...
    protected function getConditionValue($value, $operator, $field)
    {
        ...
        foreach ($valueArray as $value) {
            ...
            $isNumeric = $this->isNumericType($field->getFieldDataType());
                $isBirthdayPeriod = $field->getFieldName() == 'birthday' && $this->isRelativeSearchOperators($operator);
                $isStringType = !$isNumeric || $isBirthdayPeriod;
            if ($isStringType) {
                $value = "'$value'";
            }
